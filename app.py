...
def delete_user(user_id):
    ...
    if user:
        # User found, delete from the database
...
def crud_create():
    if request.method == 'POST':
        ...
        cursor.execute("INSERT INTO dbo.crud (Id,vehicle, type, fuel_consumption) VALUES (%s,%s, %s, %s)",
...
def crud_delete(id):
    if request.method == 'POST':
        ...
        if entry:
            # Entry found, delete from the database
